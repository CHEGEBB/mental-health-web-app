                        ...
                        {bookingState.confirmed ? (
                          ...
                          >
                            ...
                            <p className="mb-6 text-center text-slate-300">
                              You are scheduled with {selectedTherapist.name} on {format(bookingState.selectedDate, 'EEEE, MMMM d, yyyy')} at {bookingState.selectedTime}.
                            </p>
                            <div className="p-4 mb-6 rounded-lg bg-slate-700">
                              ...
                              <div className="px-3 py-2 text-sm rounded bg-slate-600 text-slate-300">
                                ...
                                <p>Find a quiet, private space for your session. Have a notebook ready to write down insights. Think about what you would like to focus on during your time together.</p>
                              </div>
                            </div>
