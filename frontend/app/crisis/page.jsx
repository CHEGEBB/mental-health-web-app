            ...
            <section className="mb-8">
              ...
              <div className="p-6 rounded-lg bg-slate-700">
                <div className="flex flex-col items-center mb-4 md:flex-row md:items-start">
                  ...
                  <div>
                    <h3 className="mb-2 text-lg font-medium text-white">You're Not Alone</h3>
            ...
            <section>
              ...
              <div className="p-5 rounded-lg bg-slate-700">
                ...
                <p className="mb-4 text-slate-300">
                  It's important to reach out for professional help if you or someone you know is experiencing:
                </p>
                <ul className="mb-6 space-y-2 text-slate-300">
                  ...
                  <li className="flex items-start">
                    <AlertTriangle className="w-5 h-5 mr-2 text-amber-500 shrink-0" />
                    <span>Overwhelming feelings of hopelessness or despair that won't go away</span>
                  </li>
                  <li className="flex items-start">
                    <AlertTriangle className="w-5 h-5 mr-2 text-amber-500 shrink-0" />
                ...
                <p className="mb-4 text-slate-300">
                  If you're helping someone who's experiencing a mental health crisis:
                </p>
