              ...
              {isLoading ? (
                ...
                >
                  ...
                  <motion.section variants={itemVariants}>
                    ...
                    {filteredResources.length === 0 ? (
                      <div className="flex flex-col items-center justify-center p-8 rounded-lg bg-slate-700">
                        ...
                        <p className="mb-4 text-center text-slate-400">Try adjusting your search or filters to find what you are looking for.</p>
                        <button className="px-4 py-2 text-sm font-medium text-white rounded-md bg-emerald-600 hover:bg-emerald-700">
                          Reset Filters
                        </button>
                      </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-300">Treat yourself with the same kindness you would offer to a good friend. Self-criticism rarely leads to positive change.</p>
                        </div>
                      </div>
                      <div className="flex">
                      ...
                      <div className="flex">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-300">Sleep isnt a luxury—its essential maintenance for your brain. Aim for 7-9 hours of quality sleep each night.</p>
                        </div>
                      </div>
                    </div>
                  ...
                  <motion.section variants={itemVariants} className="p-5 rounded-lg bg-gradient-to-r from-blue-900/50 to-purple-900/50">
                    ...
                    <p className="mb-4 text-slate-300">Research shows that regularly practicing gratitude can significantly improve mental wellbeing. Take just 5 minutes each day to write down three things you are grateful for.</p>
                    ...
                    <div className="p-6">
                      ...
                      <div className="p-4 mb-6 border rounded-lg border-slate-700">
                        ...
                        <ul className="pl-5 mb-3 space-y-2 text-sm list-disc text-slate-300">
                          <li>Find a quiet, comfortable place where you wont be disturbed</li>
                          <li>You can either sit or lie down in a relaxed position</li>
                          <li>Consider using headphones for the best experience</li>
                          <li>Follow the guidance and remember there is no right way to do this</li>
                        </ul>
                      </div>
